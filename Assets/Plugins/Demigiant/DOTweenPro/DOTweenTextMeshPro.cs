...
namespace DG.Tweening
{
    ...
    public static class ShortcutExtensionsTMPText
    {
        ...
        public static TweenerCore<string, string, StringOptions> DOText(this TMP_Text target, string endValue, float duration, bool richTextEnabled = true, ScrambleMode scrambleMode = ScrambleMode.None,
