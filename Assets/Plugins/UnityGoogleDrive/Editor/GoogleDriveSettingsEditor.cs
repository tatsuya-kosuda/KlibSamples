...
namespace UnityGoogleDrive
{
    ...
    public class GoogleDriveSettingsEditor : Editor
    {
        ...
        private readonly static GUIContent genericClientCredentialsContent = new GUIContent("Generic Credentials",
                                                                                            "Google Drive API application credentials used to authorize requests via loopback and redirect schemes.");
        private readonly static GUIContent uriSchemeClientCredentialsContent = new GUIContent("URI Scheme Credentials",
