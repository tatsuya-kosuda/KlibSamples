...
namespace UniRx.Async.Triggers
{
    ...
    public class AsyncMouseTrigger : AsyncTriggerBase
    {
        ...
        {
            return Concat(onMouseDown, onMouseDowns, onMouseDrag, onMouseDrags, onMouseEnter, onMouseEnters, onMouseExit, onMouseExits, onMouseOver, onMouseOvers, onMouseUp, onMouseUps, onMouseUpAsButton,
                          onMouseUpAsButtons);
        }
