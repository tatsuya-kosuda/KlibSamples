    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                half4 base = tex2D(_GrabTexture, IN.projPos.xy);
				...
				if (base.r < 0.5 && base.g < 0.5 && base.b < 0.5)
				{
                    //fixed4 res = color * base * 2;
                    //res.a = color.a;
                    fixed4 res = color * base * 2;
                    res.a = color.a;
                    return res;
				...
				{
					fixed4 res = 1 - 2 * (1 - color) * (1 - base);
                    res.a = color.a;
                    //fixed4 res = color + base - (color * base);
                    //res.a = color.a;
                    return res;
				}
            }
