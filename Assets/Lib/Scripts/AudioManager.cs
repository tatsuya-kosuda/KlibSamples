...
namespace Kosu.UnityLibrary
{
    public class AudioManager : Singleton<AudioManager>
    {
        ...
        public void PlaySE(string clipName, float pitch = 1, float duration = 0f, float maxDistance = 500, float vol = 1)
        {
            var audioData = GetAudioData();
            audioData.Setup(_mixer.FindMatchingGroups("SE")[0]);
        ...
        public void PlayBGM(string clipName)
        {
            ...
            var audioData = GetAudioData();
            audioData.Setup(_mixer.FindMatchingGroups("BGM")[0], true);
